...
export function viewFactory_AuthenticationComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AuthenticationComponent === null)) {
        (renderType_AuthenticationComponent = viewUtils.createRenderComponentType('D:/mean_course/assets/app/auth/authentication.component.ts class AuthenticationComponent - inline template', 0, import9.ViewEncapsulation.None, styles_AuthenticationComponent, {}));
    }
...
var _View_AuthenticationComponent1 = (function (_super) {
    ...
    _View_AuthenticationComponent1.prototype.createInternal = function (rootSelector) {
        ...
        this._text_2 = this.renderer.createText(this._el_1, 'Sign-in', null);
        this._expr_0 = import7.UNINITIALIZED;
